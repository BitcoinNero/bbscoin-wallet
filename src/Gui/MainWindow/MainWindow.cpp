...
const char COMMUNITY_FORUM_URL[] = "http://btcnero.org";
const char REPORT_ISSUE_URL[] = "http://btcnero.org";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Bitcoin Nero Wallet %1").arg(Settings::instance().getVersion()));
