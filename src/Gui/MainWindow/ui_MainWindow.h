...
public:
    ...
    QAction *m_aboutBitcoinNeroAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/bitcoinnero"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutBitcoinNeroAction = new QAction(MainWindow);
        m_aboutBitcoinNeroAction->setObjectName(QStringLiteral("m_aboutBitcoinNeroAction"));
        m_aboutBitcoinNeroAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutBitcoinNeroAction);
        ...
        QObject::connect(m_aboutBitcoinNeroAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutBitcoinNeroAction->setText(QApplication::translate("MainWindow", "About Bitcoin Nero", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND BITCOIN NERO", 0));
